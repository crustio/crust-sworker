...
typedef enum _crust_status_t
{
    ...
    // Upgrade related
    CRUST_UPGRADE_RESTORE_SRD_FAILED = CRUST_MK_ERROR(0x1101),
    CRUST_UPGRADE_RESTORE_FILE_FAILED = CRUST_MK_ERROR(0x1102),
    CRUST_UPGRADE_SEND_WORKREPORT_FAILED = CRUST_MK_ERROR(0x1103),
    CRUST_UPGRADE_INVALID_WORKREPORT = CRUST_MK_ERROR(0x1104),
    CRUST_UPGRADE_GET_BLOCK_HASH_FAILED = CRUST_MK_ERROR(0x1105),
    CRUST_UPGRADE_GEN_WORKREPORT_FAILED = CRUST_MK_ERROR(0x1106),
    CRUST_UPGRADE_WAIT_FOR_NEXT_ERA = CRUST_MK_ERROR(0x1107),
    CRUST_UPGRADE_BAD_SRD = CRUST_MK_ERROR(0x1108),
    CRUST_UPGRADE_BAD_FILE = CRUST_MK_ERROR(0x1109),
    CRUST_UPGRADE_IS_UPGRADING = CRUST_MK_ERROR(0x1110),
    CRUST_UPGRADE_NEED_LEFT_DATA = CRUST_MK_ERROR(0x1111),
} crust_status_t;
