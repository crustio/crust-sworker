    ...
    while (true)
    {
        ...
        else if (CRUST_SUCCESS != crust_status)
        {
            ...
            case CRUST_BLOCK_HEIGHT_EXPIRED:
                p_log->err("Block height has expired, please check your chain.\n");
                break;
            ...
            case CRUST_SERVICE_UNAVAILABLE:
                p_log->err("IPFS is offline, please check and restart ipfs.\n");
                break;
            ...
            case CRUST_WORK_REPORT_NOT_VALIDATED:
                p_log->err("Hardware is too slow, validation has not been applied.\n");
                break;
            default:
