...
typedef enum _crust_status_t
{
    ...
    // Upgrade related
    CRUST_UPGRADE_RESTORE_SRD_FAILED = CRUST_MK_ERROR(0x1001),
    CRUST_UPGRADE_RESTORE_FILE_FAILED = CRUST_MK_ERROR(0x1002),
    CRUST_UPGRADE_SEND_WORKREPORT_FAILED = CRUST_MK_ERROR(0x1003),
    CRUST_UPGRADE_INVALID_WORKREPORT = CRUST_MK_ERROR(0x1004),
    CRUST_UPGRADE_GET_BLOCK_HASH_FAILED = CRUST_MK_ERROR(0x1005),
    CRUST_UPGRADE_GEN_WORKREPORT_FAILED = CRUST_MK_ERROR(0x1006),
    CRUST_UPGRADE_WAIT_FOR_NEXT_ERA = CRUST_MK_ERROR(0x1007),
    CRUST_UPGRADE_BAD_SRD = CRUST_MK_ERROR(0x1008),
    CRUST_UPGRADE_BAD_FILE = CRUST_MK_ERROR(0x1009),
    CRUST_UPGRADE_IS_UPGRADING = CRUST_MK_ERROR(0x1010),
    CRUST_UPGRADE_NEED_LEFT_DATA = CRUST_MK_ERROR(0x1011),
    CRUST_UPGRADE_BLOCK_EXPIRE = CRUST_MK_ERROR(0x1012),
    CRUST_UPGRADE_NO_VALIDATE = CRUST_MK_ERROR(0x1013),
    CRUST_UPGRADE_RESTART = CRUST_MK_ERROR(0x1014),
    CRUST_UPGRADE_NO_FILE = CRUST_MK_ERROR(0x1015),
} crust_status_t;
