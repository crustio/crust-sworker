...
typedef enum _crust_status_t
{
    ...
    CRUST_BAD_SEAL_DATA = CRUST_MK_ERROR(0x4003),
    CRUST_SGX_FAILED = CRUST_MK_ERROR(0x4004),
    CRUST_NOT_EQUAL = CRUST_MK_ERROR(0x4005),
    CRUST_SGX_SIGN_FAILED = CRUST_MK_ERROR(0x4006),
    CRUST_SGX_VERIFY_SIG_FAILED = CRUST_MK_ERROR(0x4007),
    CRUST_UNEXPECTED_ERROR = CRUST_MK_ERROR(0x4008),
    CRUST_INVALID_MERKLETREE = CRUST_MK_ERROR(0x4009),
    CRUST_MALWARE_DATA_BLOCK = CRUST_MK_ERROR(0x4010),
    CRUST_OPEN_FILE_FAILED = CRUST_MK_ERROR(0x4011),
    CRUST_WRITE_FILE_FAILED = CRUST_MK_ERROR(0x4012),
    CRUST_DELETE_FILE_FAILED = CRUST_MK_ERROR(0x4013),
    CRUST_RENAME_FILE_FAILED = CRUST_MK_ERROR(0x4014),
    CRUST_MKDIR_FAILED = CRUST_MK_ERROR(0x4015),
    CRUST_ACCESS_FILE_FAILED = CRUST_MK_ERROR(0x4016),
    CRUST_INVALID_META_DATA = CRUST_MK_ERROR(0x4017),
    CRUST_INIT_QUOTE_FAILED = CRUST_MK_ERROR(0x4018),
    CRUST_SRD_NUMBER_EXCEED = CRUST_MK_ERROR(0x4019),
    CRUST_FILE_NUMBER_EXCEED = CRUST_MK_ERROR(0x4020),
    CRUST_DEVICE_ERROR = CRUST_MK_ERROR(0x4021),
    CRUST_OCALL_NO_ENOUGH_BUFFER = CRUST_MK_ERROR(0x4022),

    // Json error
    CRUST_JSON_ARRAY_ERROR = CRUST_MK_ERROR(0x5001),
    CRUST_JSON_OBJECT_ERROR = CRUST_MK_ERROR(0x5002),
    CRUST_JSON_STRING_ERROR = CRUST_MK_ERROR(0x5003),
    CRUST_JSON_BOOL_ERROR = CRUST_MK_ERROR(0x5004),
    CRUST_JSON_NULL_ERROR = CRUST_MK_ERROR(0x5005),
    CRUST_JSON_NUMBER_ERROR = CRUST_MK_ERROR(0x5006),
    CRUST_JSON_STARTING_ERROR = CRUST_MK_ERROR(0x5007),
    ...
    CRUST_STORAGE_NO_ENOUGH_SPACE = CRUST_MK_ERROR(0x8016),
    CRUST_STORAGE_INCOMPLETE_BLOCK = CRUST_MK_ERROR(0x8017),
    ...
    // For http
    CRUST_HTTP_INVALID_INPUT = CRUST_MK_ERROR(0x11001),
} crust_status_t;
