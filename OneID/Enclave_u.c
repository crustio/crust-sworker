...
sgx_status_t get_report(sgx_enclave_id_t eid, sgx_status_t* retval, sgx_report_t* report, sgx_target_info_t* target_info, unsigned char* tmpBuffer)
{
	sgx_status_t status;
	ms_get_report_t ms;
	ms.ms_report = report;
	ms.ms_target_info = target_info;
	ms.ms_tmpBuffer = tmpBuffer;
