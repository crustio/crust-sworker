...
typedef enum _common_status_t
{
    ...
    CRUST_INVALID_MERKLETREE = COMMON_MK_ERROR(0x0412),
    CRUST_NOTFOUND_MERKLETREE = COMMON_MK_ERROR(0x0413),
    CRUST_INVALID_SEALED_DATA = COMMON_MK_ERROR(0x0414),
    CRUST_VERIFY_MEANINGFUL_FAILED = COMMON_MK_ERROR(0x0415),
    CRUST_GET_FILE_BLOCK_FAILED = COMMON_MK_ERROR(0x0416),
    CRUST_WRONG_FILE_BLOCK = COMMON_MK_ERROR(0x0417),
    CRUST_SEAL_NOTCOMPLETE = COMMON_MK_ERROR(0x0418),
    CRUST_DESER_MERKLE_TREE_FAILED = COMMON_MK_ERROR(0x0419),
    CRUST_GET_MERKLETREE_FAILED = COMMON_MK_ERROR(0x0420),
    CRUST_MERKLETREE_DUPLICATED = COMMON_MK_ERROR(0x0421),
    CRUST_MALWARE_DATA_BLOCK = COMMON_MK_ERROR(0x0422),
} common_status_t;
